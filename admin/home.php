            ...
            <div class="row mt-5">
                <div class="col-sm-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Click here to see the requesting to dock ships.</p>
            ...
            <div class="row mt-5">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Click here to find out complains regarding ship</p>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Click here to see reports from employees and officers</p>
