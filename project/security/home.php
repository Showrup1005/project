    ...
    <div class="">
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <div class="card mx-2">
                <div class="card-body">
                    <h5 class="card-title">Assigned Ship</h5>
                    <p class="card-text">See if you are assigned to any ship to check</p>
                    <a href="currentship.php" class="btn btn-primary">See</a>
                </div>
                </div>
            </div>
            <div class="col-md-6">
